...
async function main() {
  ...
  await runTest('AuthService register should create user and return session token', () => {
  ...
  await runTest('AuthService login should authenticate user with valid credentials', () => {
  ...
  await runTest('AuthService verifySession should return user profile for active token', () => {
  ...
  await runTest('AIGatewayService should process query with grounded citations and verification check', async () => {
    const mockNotes = [
  ...
  await runTest('AIGatewayService rate limiter should restrict rapid abusive queries', async () => {
  ...
  await runTest('RAGEngine should execute query and return grounded answer with citations', () => {
    const sampleNotes = [
  ...
  await runTest('DatabaseService should persist and retrieve chat history across operations', () => {
  ...
  await runTest('PromptSecurityAgent should flag malicious injection attempts', () => {
  ...
  await runTest('VerificationAgent should enforce anti-hallucination guard when evidence is insufficient', () => {
  ...
  await runTest('BM25Engine should rank documents by keyword relevance', () => {
  ...
  await runTest('OrchestratorService should classify user intent and select modular tools', () => {
  ...
  await runTest('ContextPlannerService should resolve multi-turn references and build token-budgeted window', () => {
  ...
  await runTest('PostgresStoreService should generate production-grade SQL DDL schema for enterprise scale', () => {
